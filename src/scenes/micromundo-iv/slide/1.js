    ...
    return (
      <ContentBox>
        ...
        <PrimaryText>
          ...
          <p> Por essa razão propomos explorar alguns dos elementos envolvidos na organização de Olimpíadas Escolares, buscando ilustrar como os pilares do Pensamento Computacional, associados a certas habilidades específicas, podem auxiliar na construção de soluções.</p>
