    ...
    return (
      <ContentBox>
        <PrimaryText>
          ...
          <p>A preparação física para participação na Olimpíadas Escolares inclui exercícios de flexibilidade, treinamento de força e treinamento de resistência, com os exercícios organizados e sequenciados especificamente para cada esporte ou competição.</p>
